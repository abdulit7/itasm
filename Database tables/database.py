...
def recreate_database():
    try:
        ...
        # Create assets table with category_id
        create_assets_table = """
        CREATE TABLE assets (
            id INT AUTO_INCREMENT PRIMARY KEY,
            category_id INT,
        ...
        # Create components table with category_id
        create_components_table = """
        CREATE TABLE components (
            id INT AUTO_INCREMENT PRIMARY KEY,
            category_id INT,
        ...
        # Create devices table with category_id
        create_devices_table = """
        CREATE TABLE devices (
            id INT AUTO_INCREMENT PRIMARY KEY,
            category_id INT,
        ...
        # Create consumables table with category_id
        create_consumables_table = """
        CREATE TABLE consumables (
            id INT AUTO_INCREMENT PRIMARY KEY,
            category_id INT,
