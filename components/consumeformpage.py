...
#             border_color=ft.Colors.ORANGE_200
#         )
#         self.consumable_image = ft.FilePicker(on_result=self.handle_consumable_image)
...
#         self.attached_image = file_data
#         self.consumable_image_button.text = file.name
#         self.consumable_image_button.update()
...
#             with open(file.path, "rb") as f:
#                 file_data["data"] = f.read()
#         self.attached_bill = file_data
#         self.bill_image_button.text = file.name
#         self.bill_image_button.update()
